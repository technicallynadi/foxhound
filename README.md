...
- **External scouting** (`foxhound scout`) — Connectors pull signals from GitHub Trending, Reddit, and HackerNews. Raw opportunities are scored on star velocity, improvability, buildability, and business value using configurable scoring profiles.
