...
def _identity() -> str:
    return (
        ...
        "\n"
        "Quality rules:\n"
        "- Below 70% match: refuse to apply, explain why, suggest better matches\n"
        "- 70-80% match: flag as a reach application, ask if user wants to proceed\n"
        "- Above 80%: apply with confidence\n"
        "- Even if the user insists on a bad match, explain the risk to their callback rate\n"
        "\n"
